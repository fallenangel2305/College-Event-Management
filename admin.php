	...
	<div class="row">
	  ...
	  <div class="col-md-4">
		<div class="text-left"  >
				  ...
				  <div class="modal-dialog modal-xl">
					<div class="modal-content">
					  ...
					  <div class="modal-body">
						...
						<?php include 'admin-prog-modal-data.php'; ?>	
				...
				<!-- Judge Modal -->
				<div class="modal fade" id="judge-admin" tabindex="-1" aria-labelledby="judge-admin" aria-hidden="true">
				  <div class="modal-dialog modal-xl">
					<div class="modal-content">
					  <div class="modal-header">
					  ...
					  <div class="modal-body">
						...
						<?php include 'admin-judge-modal-data.php'; ?>	
				...
				<!-- Participants Modal -->
				<div class="modal fade" id="particip-admin" tabindex="-1" aria-labelledby="particip-admin" aria-hidden="true">
				  <div class="modal-dialog modal-xl">
					<div class="modal-content">
					  <div class="modal-header">
				  ...
				  <tr>
					<th>
						...
						<div class="container">
								...
								<div class="card">
									<div class="card-body">
										<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#judge-admin">
										  &nbsp;&nbsp;&nbsp;&nbsp; Judges &nbsp;&nbsp;&nbsp;&nbsp;
										</button>
									</div>
								</div>
				  ...
				  <tr>
					<th>
						...
						<div class="container">
								...
								<div class="card">
									<div class="card-body">
										<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#particip-admin">
										  Participants List
										</button>
									</div>
								</div>
