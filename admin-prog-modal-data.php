            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
                        <h2 class="pull-left">Program List</h2>
						<a href="admin-prog-modal-data-create.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add New Program</a>
                    </div>
                    <?php
                    // Include config file
